...
def get_db_col_name(subject_name):
    ...
    # Fallback default transformation for standard subject names
...
# --- PAGE 2: STUDENTS REGISTRATION (RESTRICTED TO ADMIN) ---
    ...
    with tab_manage:
        ...
        # Grade filter for easier navigation
        ...
        try:
            ...
            if not students_list:
                ...
                st.caption("Click on any cell to edit details directly, then click 'Save Changes' below.")
                ...
                st.markdown("---")
                st.markdown("#### Deregister / Remove Student")
                ...
                if confirm_delete and student_to_delete:
                    ...
                    try:
                        # Optional: Remove related marks record
